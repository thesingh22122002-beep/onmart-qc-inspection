...
const SHELL = ['/qc.html','/xlsx.full.min.js','/jszip.min.js','/jspdf.umd.min.js','/jspdf.plugin.autotable.min.js', '/manifest.webmanifest', '/icon-192.png', '/icon-512.png'];
...
self.addEventListener('fetch', e => {
  ...
  e.respondWith(
    fetch(req)
      ...
      .catch(() => caches.match(req).then(hit => hit || caches.match('/qc.html')))
  );
});
